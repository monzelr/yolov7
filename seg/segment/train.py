...
def train(hyp, opt, device, callbacks):  # hyp is path/to/hyp.yaml or hyp dictionary
    ...
    if pretrained:
        ...
        model = SegmentationModel(cfg or ckpt['model'].yaml, ch=1 if opt.gray else 3, nc=nc,
        ...
        model = SegmentationModel(cfg, ch=1 if opt.gray else 3, nc=nc, anchors=hyp.get('anchors')).to(device)  # create
...
def parse_opt(known=False):
    ...
    parser.add_argument('--gray', action='store_true', help='input images are gray scaled')
